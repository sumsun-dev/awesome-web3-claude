...
<details><summary>asksurf-ai/surf-skills 스킬 상세 (1개)</summary>
...
| [twzrd-sol/wzrd-intel-live](https://intel.twzrd.xyz) | ![](https://img.shields.io/github/stars/twzrd-sol/wzrd-intel-live?style=flat-square&logo=github) | `Official` | '26.06 | 솔라나 AI 에이전트 지갑 신뢰도 점수 MCP. score_agent, preflight_check (무료), get_trust_receipt (x402 유료) |

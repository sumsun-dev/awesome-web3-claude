...
| [quiknode-labs/blockchain-skills](https://github.com/quiknode-labs/blockchain-skills) | ![](https://img.shields.io/github/stars/quiknode-labs/blockchain-skills?style=flat-square&logo=github) | `Community` | '26.03 | 클로드 코드와 같은 AI 에이전트에서 사용할 수 있는 블록체인 개발 스킬 모음으로, Ethereum, Solana 등 다양한 블록체인 플랫폼 작업을 자동화할 수 있습니다. `1개 스킬` |

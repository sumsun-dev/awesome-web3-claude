...
| [quiknode-labs/blockchain-skills](https://github.com/quiknode-labs/blockchain-skills) | ![](https://img.shields.io/github/stars/quiknode-labs/blockchain-skills?style=flat-square&logo=github) | `Community` | '26.03 | Claude CodeのようなAIエージェントで使用できるブロックチェーン開発スキル集で、Ethereum、Solanaなど様々なブロックチェーンプラットフォームの作業を自動化できます。 `1個スキル` |
